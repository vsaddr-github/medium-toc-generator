...
def generate_toc(html_text: str) -> str:
    ...
    links = []
    preserve_case = {
        'i':'I','I':'I','canon':'Canon','nikon':'Nikon','sony':'Sony','fuji':'Fuji',
        'fujifilm':'Fujifilm','leica':'Leica','hasselblad':'Hasselblad','sigma':'Sigma'
    }
...
async def upload(file: UploadFile = File(...)):
    ...
    <p>Copy the HTML below and paste it at the top of your Medium article.</p>
    <div class='copy-box'>
    <textarea id="tocbox">{toc_html}</textarea><br>
    <button class="button" onclick="navigator.clipboard.writeText(document.getElementById('tocbox').value)">Copy to Clipboard</button>
    </div>
